...
(function (factory) {
  ...
  $.fn.numeric = function (config, callback) {
    ...
    var altDecimal =
      config.altDecimal === false ? "" : config.altDecimal || decimal;
    // allow negatives
    ...
    return this.data("numeric.decimal", decimal)
      .data("numeric.altDecimal", altDecimal)
  ...
  $.fn.numeric.keypress = function (e) {
    ...
    if (key < 48 || key > 57) {
      ...
      if (
        (decimal && key == decimal.charCodeAt(0)) ||
        (altDecimal && key == altDecimal.charCodeAt(0))
      ) {
